...
Version 0.1 is read-only, source-grounded in firmware v0.2.5. Live reads verified
controller reachability and disconnected-CN105 handling; connected equipment
telemetry remains unverified. Do not claim support for writes, ESPHome, or Matter. Do not send
